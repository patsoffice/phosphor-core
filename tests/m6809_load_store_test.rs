...
fn test_reset() {
    ...
    assert_eq!(sys.get_cpu_state().pc, 4, "PC should be at 0x04 after both instructions");
}
...
fn test_multiple_loads_and_stores() {
    ...
    assert_eq!(sys.get_cpu_state().a, 0x22, "A register should be 0x22 (last loaded value)");
